...
public class Client : MonoBehaviour
{
    ...
    private void initializeClientData()
    {
        packetHandlers = new Dictionary<int, PacketHandler>()
        {
            ...
            {(int)ServerPackets.winner, ClientHandle.winner },
            {(int)ServerPackets.playerSpectate, ClientHandle.playerSpectate },
            {(int)ServerPackets.playerProjectile, ClientHandle.playerProjectile },
            {(int)ServerPackets.playerUpdateHealth, ClientHandle.playerUpdateHealth },
            {(int)ServerPackets.playerUpdateStamina, ClientHandle.playerUpdateStamina },
            {(int)ServerPackets.extinctionEvent, ClientHandle.extinctionEvent },
